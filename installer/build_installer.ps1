...
Copy-Item (Join-Path $root "NotebookFlow\notebookflow-agent-template.md") (Join-Path $nfDir "notebookflow-agent-template.md") -Force
...
Write-Host "  -> bin\notebookflow\ 조립 완료 (NotebookFlow.exe/rest.sce/user.sce/CLAUDE.md/help.json/cacert.pem/notebookflow-agent-template.md/frontend)"
