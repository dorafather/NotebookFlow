   ...
   goto out;
    ...
    case json_tokener_state_null:
      ...
      if(strncasecmp(json_null_str, tok->pb->buf,
           json_min((unsigned int)(tok->st_pos+1), strlen(json_null_str))) == 0) {
   if((unsigned int)(tok->st_pos) == strlen(json_null_str)) {
     current = NULL;
       ...
       */
   {
    ...
    case json_tokener_state_boolean:
      ...
      if(strncasecmp(json_true_str, tok->pb->buf,
           json_min((unsigned int)(tok->st_pos+1), strlen(json_true_str))) == 0) {
   if((unsigned int)(tok->st_pos) == strlen(json_true_str)) {
     ...
     goto redo_char;
             ...
             json_min((unsigned int)(tok->st_pos+1), strlen(json_false_str))) == 0) {
   if((unsigned int)(tok->st_pos) == strlen(json_false_str)) {
